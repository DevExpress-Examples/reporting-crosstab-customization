Partial Public Class HideWhenNoOrNullValues
	''' <summary>
	...
	Private Sub InitializeComponent()
		...
		Dim crossTabColumnDefinition5 As New DevExpress.XtraReports.UI.CrossTab.CrossTabColumnDefinition(60F)
		Dim crossTabColumnDefinition6 As New DevExpress.XtraReports.UI.CrossTab.CrossTabColumnDefinition(60F)
		...
		Dim crossTabDataField3 As New DevExpress.XtraReports.UI.CrossTab.CrossTabDataField()
		...
		Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(HideWhenNoOrNullValues))
		...
		Me.crossTabHeaderCell11 = New DevExpress.XtraReports.UI.CrossTab.XRCrossTabCell()
		...
		Me.cfValue2 = New DevExpress.XtraReports.UI.CalculatedField()
		...
		' crossTab1
		' 
		Me.crossTab1.Cells.AddRange(New DevExpress.XtraReports.UI.XRControl() { Me.crossTabHeaderCell1, Me.crossTabDataCell1, Me.crossTabHeaderCell2, Me.crossTabHeaderCell3, Me.crossTabHeaderCell4, Me.crossTabTotalCell1, Me.crossTabHeaderCell5, Me.crossTabTotalCell2, Me.crossTabTotalCell3, Me.crossTabHeaderCell6, Me.crossTabHeaderCell7, Me.crossTabHeaderCell8, Me.crossTabHeaderCell9, Me.crossTabDataCell2, Me.crossTabTotalCell5, Me.crossTabTotalCell4, Me.crossTabTotalCell6, Me.crossTabHeaderCell10, Me.crossTabHeaderCell11, Me.crossTabDataCell3, Me.crossTabTotalCell8, Me.crossTabTotalCell7, Me.crossTabTotalCell9})
		...
		crossTabDataField3.FieldName = "cfValue2"
		crossTabDataField3.SummaryType = DevExpress.XtraReports.UI.CrossTab.SummaryType.Count
		Me.crossTab1.DataFields.AddRange(New DevExpress.XtraReports.UI.CrossTab.CrossTabDataField() { crossTabDataField1, crossTabDataField2, crossTabDataField3})
		...
		Me.crossTab1.SizeF = New System.Drawing.SizeF(445F, 100F)
		...
		Me.crossTabHeaderCell2.ColumnSpan = 3
		...
		' crossTabHeaderCell5
		' 
		Me.crossTabHeaderCell5.ColumnIndex = 4
		Me.crossTabHeaderCell5.ColumnSpan = 3
		...
		' crossTabTotalCell3
		' 
		Me.crossTabTotalCell3.ColumnIndex = 4
		...
		Me.crossTabTotalCell5.ColumnIndex = 5
		...
		Me.crossTabTotalCell4.ExpressionBindings.AddRange(New DevExpress.XtraReports.UI.ExpressionBinding() { New DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "ColumnVisible", "[cfValue2] > 0" & ControlChars.Lf)})
		...
		Me.crossTabTotalCell6.ColumnIndex = 5
		Me.crossTabTotalCell6.ExpressionBindings.AddRange(New DevExpress.XtraReports.UI.ExpressionBinding() { New DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "ColumnVisible", "[cfValue2] > 0" & ControlChars.Lf)})
		Me.crossTabTotalCell6.Name = "crossTabTotalCell6"
		Me.crossTabTotalCell6.RowIndex = 3
		' 
		' crossTabHeaderCell10
		' 
		Me.crossTabHeaderCell10.ColumnIndex = 3
		Me.crossTabHeaderCell10.Name = "crossTabHeaderCell10"
		Me.crossTabHeaderCell10.RowIndex = 1
		Me.crossTabHeaderCell10.Text = "cf (cnt)"
		' 
		' crossTabHeaderCell11
		' 
		Me.crossTabHeaderCell11.ColumnIndex = 6
		Me.crossTabHeaderCell11.Name = "crossTabHeaderCell11"
		Me.crossTabHeaderCell11.RowIndex = 1
		Me.crossTabHeaderCell11.Text = "cf (cnt)"
		' 
		' crossTabDataCell3
		' 
		Me.crossTabDataCell3.ColumnIndex = 3
		Me.crossTabDataCell3.Name = "crossTabDataCell3"
		Me.crossTabDataCell3.RowIndex = 2
		' 
		' crossTabTotalCell8
		' 
		Me.crossTabTotalCell8.ColumnIndex = 6
		Me.crossTabTotalCell8.Name = "crossTabTotalCell8"
		Me.crossTabTotalCell8.RowIndex = 2
		' 
		' crossTabTotalCell7
		' 
		Me.crossTabTotalCell7.ColumnIndex = 3
		Me.crossTabTotalCell7.Name = "crossTabTotalCell7"
		Me.crossTabTotalCell7.RowIndex = 3
		' 
		' crossTabTotalCell9
		' 
		Me.crossTabTotalCell9.ColumnIndex = 6
		...
		' cfValue2
		' 
		Me.cfValue2.Expression = "[value2]"
		Me.cfValue2.Name = "cfValue2"
		' 
		' HideWhenNoOrNullValues
		' 
		Me.Bands.AddRange(New DevExpress.XtraReports.UI.Band() { Me.TopMargin, Me.Detail, Me.BottomMargin, Me.GroupHeader1})
		Me.CalculatedFields.AddRange(New DevExpress.XtraReports.UI.CalculatedField() { Me.cfValue2})
	...
	Private crossTabHeaderCell10 As DevExpress.XtraReports.UI.CrossTab.XRCrossTabCell
	Private crossTabHeaderCell11 As DevExpress.XtraReports.UI.CrossTab.XRCrossTabCell
	Private crossTabDataCell3 As DevExpress.XtraReports.UI.CrossTab.XRCrossTabCell
	Private crossTabTotalCell8 As DevExpress.XtraReports.UI.CrossTab.XRCrossTabCell
	Private crossTabTotalCell7 As DevExpress.XtraReports.UI.CrossTab.XRCrossTabCell
	Private crossTabTotalCell9 As DevExpress.XtraReports.UI.CrossTab.XRCrossTabCell
	...
	Private cfValue2 As DevExpress.XtraReports.UI.CalculatedField
End Class
