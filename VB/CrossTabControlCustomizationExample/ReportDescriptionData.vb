...
"
		Private Const string5 As String = "The CrossTab control can display only one column for a single field. To show aggregated values for multiple functions in adjacent columns, the report uses calculated fields - each field is used to calculate values for a particular function. 
